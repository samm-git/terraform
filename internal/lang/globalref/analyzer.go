...
type Analyzer struct {
	cfg             *configs.Config
	providerSchemas map[addrs.Provider]*terraform.ProviderSchema
}
...
func NewAnalyzer(cfg *configs.Config, providerSchemas map[addrs.Provider]*terraform.ProviderSchema) *Analyzer {
	if !cfg.Path.IsRoot() {
